...
requireToken(index, '/js/app.js?v=5a6', "Top-level app cache version is stale");
requireToken(app, 'content-batch-import-controller.js?v=5a6', "Batch controller cache version is stale");
