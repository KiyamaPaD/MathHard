...
requireToken(index, '/js/app.js?v=5b3', "Top-level app cache version is stale");
requireToken(app, 'content-batch-import-controller.js?v=5b3', "Batch controller cache version is stale");
