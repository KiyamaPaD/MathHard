...
requireToken(app, 'import("./learning-polish-controller.js?v=1572")', "Lesson polish must remain lazy");
requireToken(app, 'import("./admin-learning-polish-authoring.js?v=157")', "Admin authoring helpers must remain lazy");
requireToken(secure, 'import("./learning-polish-controller.js?v=1572")', "Problem polish must remain lazy");
...
for (const token of ['data-mh-build="5b3"','css/learning-workspace.css?v=1572','css/problem-workspace.css?v=157','css/content-authoring.css?v=5b3','/js/app.js?v=5b3']) requireToken(index, token, "Build/cache contract");
