...
requireToken(index, 'css/content-authoring.css?v=5b1', "Batch intake CSS cache version is stale");
requireToken(app, 'import("./content-batch-import-controller.js?v=5b1")', "Batch intake controller is not lazy-loaded");
