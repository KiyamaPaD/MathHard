...
requireToken(index, 'data-mh-build="5a5"', "Current build marker is missing");
requireToken(index, 'id="mhContentBatchImport"', "Batch intake host is missing");
requireToken(index, 'css/content-authoring.css?v=5a5', "Batch intake CSS cache version is stale");
requireToken(app, 'import("./content-batch-import-controller.js?v=5a5")', "Batch intake controller is not lazy-loaded");
