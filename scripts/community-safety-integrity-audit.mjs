...
const externalSqlPaths = [
  "local-sql/061_product_phase_04g_3_community_safety_integrity.sql",
  "local-sql/061_phase4g3_transactional_smoke_test.sql"
];
...
const migration = readExternalSql("local-sql/061_product_phase_04g_3_community_safety_integrity.sql");
const smoke = readExternalSql("local-sql/061_phase4g3_transactional_smoke_test.sql");
...
requireTokens(index, "Phase 4G.3 index cache", ["css/community-admin.css?v=4j1", "/js/app.js?v=5a6"]);
