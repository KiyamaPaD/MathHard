...
requireTokens(index, "Admin authoring markup", [
  'data-mh-build="5a3"', 'id="mhContentAuthoringPreflight"',
  'css/content-authoring.css?v=5a3', 'id="mhSubmitBtn" type="submit">Salvează draftul'
]);
...
requireTokens(app, "Independent authoring runtime", [
  'import("./content-authoring-bootstrap.js?v=5a3")',
