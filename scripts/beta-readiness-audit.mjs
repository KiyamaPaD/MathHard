...
for (const page of ["index.html", "profile.html", "u.html"]) {
  ...
  requireText(page, /mathhard-build[^>]+(?:4g4|4h|4i)/, `${page} must expose the current beta-or-later build label.`);
}
...
requireText("js/runtime-diagnostics.js", /phase-4i-localization/, "Runtime diagnostics build label is stale.");
