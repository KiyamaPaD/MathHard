...
export const revealProblemReplayAnswer=(supabase,replayId,lang="ro")=>rpc(supabase,"mh_reveal_problem_replay_answer",{p_replay_id:cleanId(replayId,"replay id"),p_locale:locale(lang)});
