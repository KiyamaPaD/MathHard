...
if (externalSqlAvailable) {
  ...
  has(fixSql, "maximumul nu este 4", "P11 negated maximum=4 regression test");
  has(fixSql, "4 nu este maximum; maximumul este 4", "P11 detached negation regression test");
  has(fixSql, "(maximumul|maximul)[ ]+(este|e)[ ]+4", "P11 affirmative maximum=4 matcher");
  has(fixSql, "5[ ]+(nu[ ]+(este|e)", "P11 tightly-bound 5-not-maximum matcher");
