(function(){
  ...
  window.MH_NumberLinePy = window.MH_NumberLinePy || (function(){
    ...
    const NL_I18N = {
      ro: {
        aria: "Axa numerelor • joc educațional",
        max: "Maxim:",
        step: "Pas:",
        grid: "grilă",
        even: "pare",
        ...
        metronome: "metronom",
        redMarker: "indicator roșu",
        setRed: "Setează roșu = valoarea curentă",
        compare: "Compară",
        export: "💾 Salvează ca PNG",
        replay: "▶︎ Reluare",
        game20: "⏱ Joc de 20 s",
        score: "scor:",
        hint: "Apasă pe axă pentru salt • rotița: mărește sau micșorează • trage: deplasează • taste: ←/→, P (par), I (impar), Spațiu (pornire/pauză), Z/X (mărire ±), R (reluare)",
        evenShort: "PAR",
        oddShort: "IMPAR",
        evenLower: "par",
        oddLower: "impar",
